...
<body>
	...
	<section class="container mt-3" style="max-width: 560px;">
		<form method="post" action="userJoinAction" style="display: block; margin-top: 90px;">
			...
			<button type="submit" class="btn"  style="background-color: #EBF7FF;">회원가입</button>
		</form>
	</section>
